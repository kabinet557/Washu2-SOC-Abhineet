...
architecture rtl of washu2_cpu is
    type state_type is (
        resetState,fetch1,fetch2,fetch3,neg1,neg2,halt1,direct1,cload1,
        direct2,add1,and1,load1,store1,indirect1,indirect2,branch1,brind3
    );
...
begin
    ...
    with std_logic_vector'(bus_pc & bus_mbr & bus_acc & bus_ir_lower & bus_ir_se & bus_alu & bus_mem) select
        ...
        case current_state is
            ...
            when fetch3 =>
                ...
                case mbr(15 downto 12) is
                    ...
                    when OP_BRIND => next_state <= direct1;
            ...
            when direct2 =>
                ...
                case ir_opcode is
                    ...
                    when OP_BRIND => next_state <= brind3;
            ...
            when indirect2 =>
                ...
                mbr_ld  <= '1';
                case ir_opcode is
                    when OP_ILOAD => next_state <= load1;
                    when OP_ISTORE => next_state <= store1;
                    when others => next_state <= fetch1;
                end case;
